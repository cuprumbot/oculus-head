...
function update(gl, left, right, position, distortion) {
	...
	gl.uniform2f(gl.getUniformLocation(distortion.program, "Scale"), 0.1469278, 0.2350845);			//comprimir horizontal y vertical
	gl.uniform2f(gl.getUniformLocation(distortion.program, "ScaleIn"), 4, 2.5);						//comprimir horizontal y vertical
	gl.uniform4f(gl.getUniformLocation(distortion.program, "HmdWarpParam"), 1, 0.22, 0.24, 0);		//distorcion
	...
	gl.uniform2f(gl.getUniformLocation(distortion.program, "LensCenter"), 0.2863248, 0.5);			//centrar en lente
	gl.uniform2f(gl.getUniformLocation(distortion.program, "ScreenCenter"), 0.25, 0.5);				//centrar en pantalla
	gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
