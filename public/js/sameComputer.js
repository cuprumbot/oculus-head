...
$( function init () {
	...
	*/
	...
	draw(canvasContext, video1, TRANS_VID1_X, TRANS_VID1_Y, CAM_WIDTH, CAM_HEIGHT, Math.PI*3/2, video2, TRANS_VID1_X+(CANV_WIDTH/2), TRANS_VID1_Y, CAM_WIDTH, CAM_HEIGHT, Math.PI*3/2);
} );